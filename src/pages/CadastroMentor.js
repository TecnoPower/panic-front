            ...
            <div className="container pt-5 ">
                <form action="" method="get">
                        ...
                        <div className="col-md ps-4">
                            <div className="form-floating">
                                <input required type="text" className="form-control"
                                    placeholder="Informe sua profissão com mais detalhes" id="campo-profissao" />
                    ...
                    <div className="row g-2 pt-2">
                        <div className="col-md ps-4">
                            <div className="form-floating">
                                <select className="form-select" id="select-area" aria-label="Floating label select example">
                                    <option selected disabled>Selecione</option>
                        ...
                        <div className="col-md ps-4">
                            <div className="form-floating">
                                <input required type="number" className="form-control" id="campo-seguranca"
                                    ...
                                    data-bs-trigger="focus" title="Atenção" data-bs-content="Guarde esse número para um possível esquecimento de
                            senha" />
